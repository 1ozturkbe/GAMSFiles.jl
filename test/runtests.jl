...
glex(str) = GAMSParse.lex(seekstart(IOBuffer(str)))

gparse(str) = GAMSParse.parseexprs(glex(str))
...
@testset "Lexing" begin
    ...
    @test lexed[3].indices == (GAMSParse.GNumber(1),)
...
@testset "Expression parsing" begin
    ...
    @test parsed.args[1] == GAMSParse.GNumber(-5)
    @test parsed.args[2] == GAMSParse.GNumber(2)
    for str in ("1 + 3 - 2", "1+3 - 2", "1 + 3-2", "1+3-2")
        parsed = gparse1(str)
        @test parsed isa GAMSParse.GCall && parsed.name == "-"
        @test length(parsed.args) == 2
        @test parsed.args[1] == GAMSParse.GCall("+", [GAMSParse.GNumber(1), GAMSParse.GNumber(3)])
        @test parsed.args[2] == GAMSParse.GNumber(2)
...
@testset "solvefor" begin
    eq = gparse1("x =e= 7")
    @test GAMSParse.solvefor(eq, "x") == (eq, true)
    @test GAMSParse.solvefor(eq, "y") == (eq, false)
    @test GAMSParse.solvefor(gparse1("7 =e= x"), "x") == (eq, true)
    @test GAMSParse.solvefor(gparse1("x + z =e= 0"), "x") == (gparse1("x =e= 0 - z"), true)
    @test GAMSParse.solvefor(gparse1("z + x =e= 1"), "x") == (gparse1("x =e= 1 - z"), true)
    @test GAMSParse.solvefor(gparse1("0 =e= x + z"), "x") == (gparse1("x =e= 0 - z"), true)
    @test GAMSParse.solvefor(gparse1("1 =e= z + x"), "x") == (gparse1("x =e= 1 - z"), true)
    @test GAMSParse.solvefor(gparse1("x - z =e= 0"), "x") == (gparse1("x =e= 0 + z"), true)
    @test GAMSParse.solvefor(gparse1("z - x =e= 1"), "x") == (gparse1("x =e= z - 1"), true)
    @test GAMSParse.solvefor(gparse1("0 =e= x - z"), "x") == (gparse1("x =e= 0 + z"), true)
    @test GAMSParse.solvefor(gparse1("1 =e= z - x"), "x") == (gparse1("x =e= z - 1"), true)
    @test GAMSParse.solvefor(gparse1("(x + 2) + z =e= -5"), "x") == (gparse1("x =e= -5 - z - 2"), true)
    @test GAMSParse.solvefor(gparse1("z + (x + 2) =e= -5"), "x") == (gparse1("x =e= -5 - z - 2"), true)
    @test GAMSParse.solvefor(gparse1("z - (x + 2) =e= 5"), "x") == (gparse1("x =e= z - 5 - 2"), true)
    @test GAMSParse.solvefor(gparse1("z - (2 - x) =e= 5"), "x") == (GAMSParse.deparen!(gparse1("x =e= 2 - (z - 5)")), true)

    @test GAMSParse.solvefor(gparse1("7 =g= x"), "x") == (gparse1("x =l= 7"), true)
    @test GAMSParse.solvefor(gparse1("x + z =g= 0"), "x") == (gparse1("x =g= 0 - z"), true)
    @test GAMSParse.solvefor(gparse1("z + x =l= 1"), "x") == (gparse1("x =l= 1 - z"), true)
    @test GAMSParse.solvefor(gparse1("0 =g= x + z"), "x") == (gparse1("x =l= 0 - z"), true)
    @test GAMSParse.solvefor(gparse1("1 =l= z + x"), "x") == (gparse1("x =g= 1 - z"), true)
    @test GAMSParse.solvefor(gparse1("x - z =g= 0"), "x") == (gparse1("x =g= 0 + z"), true)
    @test GAMSParse.solvefor(gparse1("z - x =l= 1"), "x") == (gparse1("x =g= z - 1"), true)
    @test GAMSParse.solvefor(gparse1("0 =g= x - z"), "x") == (gparse1("x =l= 0 + z"), true)
    @test GAMSParse.solvefor(gparse1("1 =g= z - x"), "x") == (gparse1("x =g= z - 1"), true)
    @test GAMSParse.solvefor(gparse1("(x + 2) + z =g= -5"), "x") == (gparse1("x =g= -5 - z - 2"), true)
    @test GAMSParse.solvefor(gparse1("z + (x + 2) =l= -5"), "x") == (gparse1("x =l= -5 - z - 2"), true)
    @test GAMSParse.solvefor(gparse1("z - (x + 2) =g= 5"), "x") == (gparse1("x =l= z - 5 - 2"), true)
    @test GAMSParse.solvefor(gparse1("z - (2 - x) =g= 5"), "x") == (GAMSParse.deparen!(gparse1("x =g= 2 - (z - 5)")), true)
end
...
@testset "eqs2assigns" begin
    ...
    sets = Dict()
    bodyexprs = Expr[]
    solved = GAMSParse.eqs2assigns!(bodyexprs, equations, vars, sets, "objval")
    @test solved["objval"]
    @test !solved["x"]
